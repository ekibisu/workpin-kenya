...
BEGIN
  ...
  VALUES (
    NEW.id,
    NEW.email,
    -- This checks both 'full_name' and 'fullname' just to be safe
...
CREATE OR REPLACE FUNCTION "public"."match_providers"("job_lat" double precision, "job_lng" double precision, "job_cat" "text", "max_results" integer DEFAULT 8) RETURNS TABLE("provider_id" "uuid", "distance_km" double precision, "score" double precision)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
  SELECT
    ...
    (
      COALESCE(pp.avg_rating, 0) * 0.4 +
      (1.0 / NULLIF(pp.response_time_minutes, 0)) * 0.3 * 100 +
      (1.0 / NULLIF(
        ST_Distance(
          pp.geom::geography,
          ST_SetSRID(ST_MakePoint(job_lng, job_lat), 4326)::geography
...
ALTER FUNCTION "public"."match_providers"("job_lat" double precision, "job_lng" double precision, "job_cat" "text", "max_results" integer) OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."disputes" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "disputes_status_check" CHECK (("status" = ANY (ARRAY['open'::"text", 'in_review'::"text", 'resolved'::"text"])))
);
...
ALTER TABLE "public"."fixed_price_services" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."job_requests" (
    ...
    "lng" double precision,
    "timeline" "text",
    CONSTRAINT "job_requests_status_check" CHECK (("status" = ANY (ARRAY['open'::"text", 'pending'::"text", 'matched'::"text", 'filled'::"text", 'completed'::"text", 'expired'::"text", 'completion_pending'::"text"]))),
    CONSTRAINT "job_requests_timeline_check" CHECK (("timeline" = ANY (ARRAY['asap'::"text", 'this_week'::"text", 'this_month'::"text", 'flexible'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."messages" (
    ...
    CONSTRAINT "messages_type_check" CHECK (("type" = ANY (ARRAY['text'::"text", 'quote'::"text", 'system'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."provider_profiles" (
    ...
    CONSTRAINT "provider_profiles_rate_type_check" CHECK (("rate_type" = ANY (ARRAY['hourly'::"text", 'per_job'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."provider_templates" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "provider_templates_body_check" CHECK (("char_length"("body") <= 500))
);


ALTER TABLE "public"."provider_templates" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."provider_wallets" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "provider_id" "uuid" NOT NULL,
    "available_balance_kes" integer DEFAULT 0 NOT NULL,
    "pending_balance_kes" integer DEFAULT 0 NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL
);


ALTER TABLE "public"."provider_wallets" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."quotes" (
    ...
    "work_thread_id" "uuid",
    "timeline" "text",
    CONSTRAINT "quotes_status_check_v2" CHECK (("status" = ANY (ARRAY['pending'::"text", 'accepted'::"text", 'declined'::"text", 'countered'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."wallet_transactions" (
    ...
    "mpesa_receipt" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "wallet_transactions_type_check" CHECK (("type" = ANY (ARRAY['credit'::"text", 'debit'::"text", 'fee'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."work_threads" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "work_threads_status_check" CHECK (("status" = ANY (ARRAY['new'::"text", 'quoted'::"text", 'negotiating'::"text", 'active'::"text", 'completed'::"text", 'reviewed'::"text", 'disputed'::"text"])))
);


ALTER TABLE "public"."work_threads" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."conversation_read_status"
    ADD CONSTRAINT "conversation_read_status_pkey" PRIMARY KEY ("user_id", "request_id");
...
ALTER TABLE ONLY "public"."fixed_price_services"
    ADD CONSTRAINT "fixed_price_services_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."payments"
    ADD CONSTRAINT "payments_mpesa_ref_key" UNIQUE ("mpesa_receipt_number");
...
ALTER TABLE ONLY "public"."provider_templates"
    ADD CONSTRAINT "provider_templates_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."provider_wallets"
    ADD CONSTRAINT "provider_wallets_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."provider_wallets"
    ADD CONSTRAINT "provider_wallets_provider_id_key" UNIQUE ("provider_id");
...
ALTER TABLE ONLY "public"."providers"
    ADD CONSTRAINT "providers_user_id_key1" UNIQUE ("user_id");
...
ALTER TABLE ONLY "public"."service_requests"
    ADD CONSTRAINT "service_requests_pkey1" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."work_threads"
    ADD CONSTRAINT "work_threads_pkey" PRIMARY KEY ("id");



CREATE INDEX "idx_job_requests_client_id" ON "public"."job_requests" USING "btree" ("client_id");
...
CREATE INDEX "provider_profiles_geom_idx" ON "public"."provider_profiles" USING "gist" ("geom");
...
CREATE OR REPLACE TRIGGER "update_providers_updated_at" BEFORE UPDATE ON "public"."provider_profiles" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
CREATE OR REPLACE TRIGGER "update_service_requests_updated_at" BEFORE UPDATE ON "public"."job_requests" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
ALTER TABLE ONLY "public"."conversation_read_status"
    ADD CONSTRAINT "conversation_read_status_request_id_fkey" FOREIGN KEY ("request_id") REFERENCES "public"."service_requests"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."direct_messages"
    ADD CONSTRAINT "direct_messages_request_id_fkey" FOREIGN KEY ("request_id") REFERENCES "public"."service_requests"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."disputes"
    ADD CONSTRAINT "disputes_filed_by_id_fkey" FOREIGN KEY ("filed_by_id") REFERENCES "public"."profiles"("id");



ALTER TABLE ONLY "public"."disputes"
    ADD CONSTRAINT "disputes_work_thread_id_fkey" FOREIGN KEY ("work_thread_id") REFERENCES "public"."work_threads"("id");



ALTER TABLE ONLY "public"."fixed_price_services"
    ADD CONSTRAINT "fixed_price_services_provider_id_fkey" FOREIGN KEY ("provider_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."messages"
    ADD CONSTRAINT "messages_work_thread_id_fkey" FOREIGN KEY ("work_thread_id") REFERENCES "public"."work_threads"("id");



ALTER TABLE ONLY "public"."payments"
    ADD CONSTRAINT "payments_user_id_fkey" FOREIGN KEY ("client_id") REFERENCES "public"."profiles"("id");



ALTER TABLE ONLY "public"."payments"
    ADD CONSTRAINT "payments_work_thread_id_fkey" FOREIGN KEY ("work_thread_id") REFERENCES "public"."work_threads"("id");
...
ALTER TABLE ONLY "public"."provider_templates"
    ADD CONSTRAINT "provider_templates_provider_id_fkey" FOREIGN KEY ("provider_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."provider_wallets"
    ADD CONSTRAINT "provider_wallets_provider_id_fkey" FOREIGN KEY ("provider_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."provider_profiles"
    ADD CONSTRAINT "providers_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."providers"
    ADD CONSTRAINT "providers_user_id_fkey1" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."quotes"
    ADD CONSTRAINT "quotes_provider_id_fkey" FOREIGN KEY ("provider_id") REFERENCES "public"."profiles"("id");



ALTER TABLE ONLY "public"."quotes"
    ADD CONSTRAINT "quotes_request_id_fkey" FOREIGN KEY ("request_id") REFERENCES "public"."job_requests"("id");



ALTER TABLE ONLY "public"."quotes"
    ADD CONSTRAINT "quotes_work_thread_id_fkey" FOREIGN KEY ("work_thread_id") REFERENCES "public"."work_threads"("id");



ALTER TABLE ONLY "public"."reviews"
    ADD CONSTRAINT "reviews_customer_id_fkey" FOREIGN KEY ("client_id") REFERENCES "public"."profiles"("id");



ALTER TABLE ONLY "public"."reviews"
    ADD CONSTRAINT "reviews_provider_id_fkey" FOREIGN KEY ("provider_id") REFERENCES "public"."profiles"("id");



ALTER TABLE ONLY "public"."reviews"
    ADD CONSTRAINT "reviews_request_id_fkey" FOREIGN KEY ("work_thread_id") REFERENCES "public"."job_requests"("id");



ALTER TABLE ONLY "public"."reviews"
    ADD CONSTRAINT "reviews_work_thread_fk" FOREIGN KEY ("work_thread_id") REFERENCES "public"."work_threads"("id");



ALTER TABLE ONLY "public"."job_requests"
    ADD CONSTRAINT "service_requests_customer_id_fkey" FOREIGN KEY ("client_id") REFERENCES "public"."profiles"("id");



ALTER TABLE ONLY "public"."service_requests"
    ADD CONSTRAINT "service_requests_customer_id_fkey1" FOREIGN KEY ("customer_id") REFERENCES "public"."profiles"("id");
...
ALTER TABLE ONLY "public"."service_requests"
    ADD CONSTRAINT "service_requests_service_id_fkey1" FOREIGN KEY ("service_id") REFERENCES "public"."services"("id");
...
ALTER TABLE ONLY "public"."wallet_transactions"
    ADD CONSTRAINT "wallet_transactions_provider_id_fkey" FOREIGN KEY ("provider_id") REFERENCES "public"."profiles"("id");



ALTER TABLE ONLY "public"."work_threads"
    ADD CONSTRAINT "work_threads_client_id_fkey" FOREIGN KEY ("client_id") REFERENCES "public"."profiles"("id");



ALTER TABLE ONLY "public"."work_threads"
    ADD CONSTRAINT "work_threads_job_request_id_fkey" FOREIGN KEY ("job_request_id") REFERENCES "public"."job_requests"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."work_threads"
    ADD CONSTRAINT "work_threads_provider_id_fkey" FOREIGN KEY ("provider_id") REFERENCES "public"."profiles"("id");



CREATE POLICY "Admin can manage services" ON "public"."services" TO "authenticated" USING ("public"."has_role"("auth"."uid"(), 'admin'::"public"."app_role"));



CREATE POLICY "Admins can update disputes" ON "public"."disputes" FOR UPDATE TO "authenticated" USING ("public"."has_role"("auth"."uid"(), 'admin'::"public"."app_role"));



CREATE POLICY "Allow insert for owner" ON "public"."client_profiles" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Allow insert for owner or service" ON "public"."client_profiles" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Allow inserts for owner" ON "public"."client_profiles" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Allow trigger inserts" ON "public"."profiles" FOR INSERT WITH CHECK (("auth"."uid"() IS NULL));



CREATE POLICY "Allow trigger inserts" ON "public"."user_roles" FOR INSERT WITH CHECK (("auth"."uid"() IS NULL));



CREATE POLICY "Allow trigger inserts when auth_null_profiles" ON "public"."profiles" FOR INSERT WITH CHECK ((( SELECT "auth"."uid"() AS "uid") IS NULL));



CREATE POLICY "Allow trigger inserts when auth_null_user_roles" ON "public"."user_roles" FOR INSERT WITH CHECK ((( SELECT "auth"."uid"() AS "uid") IS NULL));



CREATE POLICY "Anyone authenticated can view providers" ON "public"."provider_profiles" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "Anyone can view active services" ON "public"."fixed_price_services" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "Authenticated can view reviews" ON "public"."reviews" FOR SELECT USING (true);
...
CREATE POLICY "Authenticated users can create threads" ON "public"."work_threads" FOR INSERT WITH CHECK (("auth"."uid"() IS NOT NULL));



CREATE POLICY "Authenticated users create threads" ON "public"."work_threads" FOR INSERT WITH CHECK (("auth"."uid"() IS NOT NULL));



CREATE POLICY "Clients manage own profile" ON "public"."client_profiles" USING (("user_id" = "auth"."uid"()));



CREATE POLICY "Customer can create own review" ON "public"."reviews" FOR INSERT WITH CHECK (("auth"."uid"() = "client_id"));



CREATE POLICY "Customer can create requests" ON "public"."job_requests" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "client_id"));
...
CREATE POLICY "Customer can update own requests" ON "public"."job_requests" FOR UPDATE TO "authenticated" USING (("auth"."uid"() = "client_id"));
...
CREATE POLICY "Customer can update own review" ON "public"."reviews" FOR UPDATE USING (("auth"."uid"() = "client_id"));



CREATE POLICY "Customer can update quote status" ON "public"."quotes" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."job_requests"
  WHERE (("job_requests"."id" = "quotes"."request_id") AND ("job_requests"."client_id" = "auth"."uid"()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."job_requests"
  WHERE (("job_requests"."id" = "quotes"."request_id") AND ("job_requests"."client_id" = "auth"."uid"())))));



CREATE POLICY "Customer can view own requests" ON "public"."job_requests" FOR SELECT TO "authenticated" USING ((("auth"."uid"() = "client_id") OR "public"."has_role"("auth"."uid"(), 'provider'::"public"."app_role") OR "public"."has_role"("auth"."uid"(), 'admin'::"public"."app_role")));



CREATE POLICY "Customer can view own requests" ON "public"."service_requests" FOR SELECT TO "authenticated" USING ((("auth"."uid"() = "customer_id") OR "public"."has_role"("auth"."uid"(), 'provider'::"public"."app_role") OR "public"."has_role"("auth"."uid"(), 'admin'::"public"."app_role")));



CREATE POLICY "Participants can file disputes" ON "public"."disputes" FOR INSERT TO "authenticated" WITH CHECK ((("filed_by_id" = "auth"."uid"()) AND (EXISTS ( SELECT 1
   FROM "public"."work_threads" "wt"
  WHERE (("wt"."id" = "disputes"."work_thread_id") AND (("wt"."client_id" = "auth"."uid"()) OR ("wt"."provider_id" = "auth"."uid"())))))));



CREATE POLICY "Participants can send messages" ON "public"."direct_messages" FOR INSERT TO "authenticated" WITH CHECK ((("auth"."uid"() = "sender_id") AND ((EXISTS ( SELECT 1
   FROM "public"."service_requests" "sr"
  WHERE (("sr"."id" = "direct_messages"."request_id") AND ("sr"."customer_id" = "auth"."uid"())))) OR (EXISTS ( SELECT 1
   FROM "public"."quotes" "q"
  WHERE (("q"."request_id" = "direct_messages"."request_id") AND ("q"."provider_id" = "auth"."uid"()) AND ("q"."status" = 'accepted'::"text")))))));



CREATE POLICY "Participants can update their threads" ON "public"."work_threads" FOR UPDATE USING ((("client_id" = "auth"."uid"()) OR ("provider_id" = "auth"."uid"())));



CREATE POLICY "Participants can view disputes" ON "public"."disputes" FOR SELECT TO "authenticated" USING ((("filed_by_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
   FROM "public"."work_threads" "wt"
  WHERE (("wt"."id" = "disputes"."work_thread_id") AND (("wt"."client_id" = "auth"."uid"()) OR ("wt"."provider_id" = "auth"."uid"()))))) OR "public"."has_role"("auth"."uid"(), 'admin'::"public"."app_role")));



CREATE POLICY "Participants can view messages" ON "public"."direct_messages" FOR SELECT TO "authenticated" USING (((EXISTS ( SELECT 1
   FROM "public"."service_requests" "sr"
  WHERE (("sr"."id" = "direct_messages"."request_id") AND ("sr"."customer_id" = "auth"."uid"())))) OR (EXISTS ( SELECT 1
   FROM "public"."quotes" "q"
  WHERE (("q"."request_id" = "direct_messages"."request_id") AND ("q"."provider_id" = "auth"."uid"()) AND ("q"."status" = 'accepted'::"text"))))));
...
CREATE POLICY "Participants can view their threads" ON "public"."work_threads" FOR SELECT USING ((("client_id" = "auth"."uid"()) OR ("provider_id" = "auth"."uid"())));



CREATE POLICY "Participants update their threads" ON "public"."work_threads" FOR UPDATE USING ((("client_id" = "auth"."uid"()) OR ("provider_id" = "auth"."uid"())));



CREATE POLICY "Participants view their threads" ON "public"."work_threads" FOR SELECT USING ((("client_id" = "auth"."uid"()) OR ("provider_id" = "auth"."uid"())));
...
CREATE POLICY "Provider can insert own" ON "public"."provider_profiles" FOR INSERT TO "authenticated" WITH CHECK ((("auth"."uid"() = "user_id") AND "public"."has_role"("auth"."uid"(), 'provider'::"public"."app_role")));



CREATE POLICY "Provider can insert own" ON "public"."providers" FOR INSERT TO "authenticated" WITH CHECK ((("auth"."uid"() = "user_id") AND "public"."has_role"("auth"."uid"(), 'provider'::"public"."app_role")));



CREATE POLICY "Provider can update own" ON "public"."provider_profiles" FOR UPDATE TO "authenticated" USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Provider can update request status" ON "public"."job_requests" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."quotes"
  WHERE (("quotes"."request_id" = "job_requests"."id") AND ("quotes"."provider_id" = "auth"."uid"()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."quotes"
  WHERE (("quotes"."request_id" = "job_requests"."id") AND ("quotes"."provider_id" = "auth"."uid"())))));



CREATE POLICY "Provider can update request status" ON "public"."service_requests" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."quotes"
  WHERE (("quotes"."request_id" = "service_requests"."id") AND ("quotes"."provider_id" = "auth"."uid"()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."quotes"
  WHERE (("quotes"."request_id" = "service_requests"."id") AND ("quotes"."provider_id" = "auth"."uid"())))));



CREATE POLICY "Providers create own transactions" ON "public"."wallet_transactions" FOR INSERT TO "authenticated" WITH CHECK (("provider_id" = "auth"."uid"()));



CREATE POLICY "Providers delete own services" ON "public"."fixed_price_services" FOR DELETE TO "authenticated" USING (("provider_id" = "auth"."uid"()));



CREATE POLICY "Providers manage own services" ON "public"."fixed_price_services" FOR INSERT TO "authenticated" WITH CHECK (("provider_id" = "auth"."uid"()));



CREATE POLICY "Providers manage own templates" ON "public"."provider_templates" TO "authenticated" USING (("provider_id" = "auth"."uid"())) WITH CHECK (("provider_id" = "auth"."uid"()));



CREATE POLICY "Providers manage own wallet" ON "public"."provider_wallets" FOR INSERT TO "authenticated" WITH CHECK (("provider_id" = "auth"."uid"()));



CREATE POLICY "Providers update own services" ON "public"."fixed_price_services" FOR UPDATE TO "authenticated" USING (("provider_id" = "auth"."uid"()));



CREATE POLICY "Providers update own wallet" ON "public"."provider_wallets" FOR UPDATE TO "authenticated" USING (("provider_id" = "auth"."uid"()));



CREATE POLICY "Providers view own transactions" ON "public"."wallet_transactions" FOR SELECT TO "authenticated" USING (("provider_id" = "auth"."uid"()));



CREATE POLICY "Providers view own wallet" ON "public"."provider_wallets" FOR SELECT TO "authenticated" USING (("provider_id" = "auth"."uid"()));



CREATE POLICY "Public can read active services" ON "public"."services" FOR SELECT TO "authenticated", "anon" USING (("is_active" = true));



CREATE POLICY "Thread participants insert messages" ON "public"."messages" FOR INSERT WITH CHECK ((("auth"."uid"() = "sender_id") AND (EXISTS ( SELECT 1
   FROM "public"."work_threads" "wt"
  WHERE (("wt"."id" = "messages"."work_thread_id") AND (("wt"."client_id" = "auth"."uid"()) OR ("wt"."provider_id" = "auth"."uid"())))))));



CREATE POLICY "Thread participants view messages" ON "public"."messages" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."work_threads" "wt"
  WHERE (("wt"."id" = "messages"."work_thread_id") AND (("wt"."client_id" = "auth"."uid"()) OR ("wt"."provider_id" = "auth"."uid"()))))));



CREATE POLICY "User can insert own client_profile" ON "public"."client_profiles" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can create own payments" ON "public"."payments" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "client_id"));



CREATE POLICY "Users can create their own requests" ON "public"."job_requests" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "client_id"));
...
CREATE POLICY "Users can manage own read status" ON "public"."conversation_read_status" TO "authenticated" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can send messages to own jobs" ON "public"."messages" FOR INSERT TO "authenticated" WITH CHECK ((("auth"."uid"() = "sender_id") AND (EXISTS ( SELECT 1
   FROM ("public"."jobs" "j"
     JOIN "public"."quotes" "q" ON (("q"."id" = "j"."quote_id")))
  WHERE (("j"."id" = "messages"."job_id") AND (("q"."provider_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
           FROM "public"."service_requests" "sr"
          WHERE (("sr"."id" = "q"."request_id") AND ("sr"."customer_id" = "auth"."uid"()))))))))));



CREATE POLICY "Users can update own jobs" ON "public"."jobs" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."quotes" "q"
  WHERE (("q"."id" = "jobs"."quote_id") AND (("q"."provider_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
           FROM "public"."service_requests" "sr"
          WHERE (("sr"."id" = "q"."request_id") AND ("sr"."customer_id" = "auth"."uid"())))))))));
...
CREATE POLICY "Users can view job messages" ON "public"."messages" FOR SELECT TO "authenticated" USING (((EXISTS ( SELECT 1
   FROM ("public"."jobs" "j"
     JOIN "public"."quotes" "q" ON (("q"."id" = "j"."quote_id")))
  WHERE (("j"."id" = "messages"."job_id") AND (("q"."provider_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
           FROM "public"."service_requests" "sr"
          WHERE (("sr"."id" = "q"."request_id") AND ("sr"."customer_id" = "auth"."uid"())))))))) OR "public"."has_role"("auth"."uid"(), 'admin'::"public"."app_role")));



CREATE POLICY "Users can view own jobs" ON "public"."jobs" FOR SELECT TO "authenticated" USING (((EXISTS ( SELECT 1
   FROM "public"."quotes" "q"
  WHERE (("q"."id" = "jobs"."quote_id") AND (("q"."provider_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
           FROM "public"."service_requests" "sr"
          WHERE (("sr"."id" = "q"."request_id") AND ("sr"."customer_id" = "auth"."uid"())))))))) OR "public"."has_role"("auth"."uid"(), 'admin'::"public"."app_role")));
...
CREATE POLICY "Users can view own payments" ON "public"."payments" FOR SELECT TO "authenticated" USING ((("auth"."uid"() = "client_id") OR "public"."has_role"("auth"."uid"(), 'admin'::"public"."app_role")));
...
CREATE POLICY "Users can view relevant quotes" ON "public"."quotes" FOR SELECT TO "authenticated" USING ((("auth"."uid"() = "provider_id") OR (EXISTS ( SELECT 1
   FROM "public"."job_requests"
  WHERE (("job_requests"."id" = "quotes"."request_id") AND ("job_requests"."client_id" = "auth"."uid"())))) OR "public"."has_role"("auth"."uid"(), 'admin'::"public"."app_role")));



CREATE POLICY "Users can view their own requests" ON "public"."job_requests" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "client_id"));
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."work_threads";
...
GRANT ALL ON FUNCTION "public"."match_providers"("job_lat" double precision, "job_lng" double precision, "job_cat" "text", "max_results" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."match_providers"("job_lat" double precision, "job_lng" double precision, "job_cat" "text", "max_results" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."match_providers"("job_lat" double precision, "job_lng" double precision, "job_cat" "text", "max_results" integer) TO "service_role";
...
GRANT ALL ON TABLE "public"."fixed_price_services" TO "anon";
GRANT ALL ON TABLE "public"."fixed_price_services" TO "authenticated";
GRANT ALL ON TABLE "public"."fixed_price_services" TO "service_role";
...
GRANT ALL ON TABLE "public"."provider_templates" TO "anon";
GRANT ALL ON TABLE "public"."provider_templates" TO "authenticated";
GRANT ALL ON TABLE "public"."provider_templates" TO "service_role";



GRANT ALL ON TABLE "public"."provider_wallets" TO "anon";
GRANT ALL ON TABLE "public"."provider_wallets" TO "authenticated";
GRANT ALL ON TABLE "public"."provider_wallets" TO "service_role";
...
GRANT ALL ON TABLE "public"."work_threads" TO "anon";
GRANT ALL ON TABLE "public"."work_threads" TO "authenticated";
GRANT ALL ON TABLE "public"."work_threads" TO "service_role";
